...
public class RimScreen extends AbstractContainerScreen<RimMenu> {
    ...
    protected void renderBg(PoseStack poseStack, float mouseX, int mouseY, int delta) {
        ...
        // draw container
        blit(poseStack, x, y, 0, 0, this.imageWidth, CONTAINER_ROWS * 18 + 17);
        // draw player inventory
        blit(poseStack, x, y + CONTAINER_ROWS * 18 + 17, 0, 126, this.imageWidth, 96);
    ...
    private void refreshSearchResults() {
        ...
        RimServices.Search.setPredicate(string);
